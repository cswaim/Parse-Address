...
There are several changes to this branch which are in progress but you might find useful now.  The intent is to push all the changes back to Jonathon's repository once completed.
